        ...
        <div class="wrapper">
            <div class="container">
                ...
                <?php if ($isAdmin && $isLoggedInTeam) { ?>
                        ...
                        <br />
                        <span>Team Description: <br /><a href="#" class="editable" data-type="textarea" id="description" title="Update team description"><?php echo $response['description'] ?></a></span>
                    ...
                    <?php } else if($isRegistered) { ?>
                        ...
                        <br />
                        <span>Team Description: <br /><?php echo $response['description'] ?></span>
                    <?php } else {?>
