<form id="autonomous">
    ...
    <div class="btn-group" data-toggle="buttons" id='scoredGoal'>
        <label class="btn btn-warning btn-lg" id="0" onclick='goalValue = 0;
        ...
        <label class="btn btn-success btn-lg" id="15" onclick='goalValue = 15;
                updateTotals(); updateMissed(false);'>
...
<script type="text/javascript">
            ...
            function pushToLocalStorage() {
                if (!(goalValue === undefined)) {
                    ...
                    localStorage.autoMissedGoal = missedGoal;
                    hideMessage();
                    //nextPhase();
            ...
            function pullFromLocalStorage() {
                if (localStorage.autoGoalValue !== undefined) {
                    goalValue = parseInt(localStorage.autoGoalValue);
                    $("#" + goalValue).addClass("active");
                }

                if (localStorage.autoHotGoal === "true") {
                    updateHotGoal();
                    $("#hotGoal").addClass("active");
                }
